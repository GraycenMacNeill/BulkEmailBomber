...
public class UserInteraction {
    ...
    public String getSenderEmail() {
        System.out.print("\u001B[34m" + "Please enter your sender email address: ");
        return input.nextLine();
    }

    public String getRecipientEmail() {
        System.out.print("\u001B[34m" + "Please enter the recipient email address: ");
        return input.nextLine();
    }

    public int getNumberOfEmailsToSend() {
        System.out.print("\u001B[34m" + "Please enter the number of emails to send: ");
        return input.nextInt();
    }

    public String getPassword() {
        System.out.print("\u001B[34m" + "Please enter your Gmail App Password: ");
        return input.nextLine();
    }
